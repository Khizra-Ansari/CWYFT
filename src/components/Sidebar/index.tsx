...
import Logo from '../../images/logo/logoimg.svg';
...
// import logimg from '../images/cards/logo.png';
    ...
    >
      ...
      <div className="overflow-y-auto">
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 ">
          <NavLink to="/">
            <img
              className="flex h-[50%] w-[80%]  item-center ml-10"
              src={Logo}
              alt="Logo"
            />
          </NavLink>
        ...
        <div className="flex items-center ">
          <select className="h-[30px] rounded-md w-[90%] mt-4 mx-auto bg-gray-300 outline-none flex cursor-pointer gap-2 items-center justify-center appearance-none relative text-center bg-slate-200">
            <option className=" text-sm font-normal max-sm:text-[10px]">
              Alpha Inc.
            </option>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  ...
                  >
                    <img
                      className="h-6 w-6"
                      src="https://cdn.prod.website-files.com/6565124c786d4f76eddcae02/656cbb9198a3f4facf74b08b_image%20365.svg"
                      alt=""
                    />
                    My Cywift
                  </NavLink>
                ...
                <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2 mt-2">
                  COMPLIANCE
                </h3>
                ...
                <li>
                  ...
                  >
                    <div className="text-gray-200 flex items-center ml-2 mt-2  gap-2 cursor-pointer hover:text-green-500">
                      <RiThunderstormsLine />
                      <h5 className="text-gray-200 text-sm cursor-pointer hover:text-green-400">
                        Integrations
                      </h5>
                    </div>
                  </NavLink>
                ...
                <li>
                  ...
                  >
                    <div className="text-gray-200 flex items-center ml-2 mt-2 gap-2 cursor-pointer hover:text-green-400">
                      <IoSettingsOutline />
                      <h5 className=" text-sm cursor-pointer hover:text-green-400">
                        Settings
                      </h5>
                    </div>
                  </NavLink>
