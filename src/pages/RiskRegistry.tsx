      ...
      <div className="mt-4 grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 lg:col-span-9">
          <div className="col-span-12 rounded-sm border border-stroke bg-white dark:bg-boxdark px-4 sm:px-6 lg:px-8 pt-7.5 pb-5 shadow-default dark:border-strokedark h-[500px] sm:h-[600px] lg:h-[700px] relative">
            ...
            <div className="absolute mt-7 left-0 right-0 flex items-center h-20 py-[22px] w-full gap-2 bg-slate-200 dark:bg-slate-500 dark:text-white rounded-lg">
                ...
                <div className="flex items-center w-full ml-4">
                  ...
                  <div className="flex flex-col gap-[4px] mt-3 ml-2 w-full">
                    ...
                    <div className="flex gap-[6px]">
                      <div className="h-6 w-16 rounded-lg bg-red-400 relative">
                        <span className="text-[10px] absolute left-4 top-[2px]">
                          CyD-4
                        </span>
                      </div>
                      <div className="h-6 w-16 rounded-lg bg-teal-200 relative">
                        <span className="text-[10px] absolute left-4 top-[2px]">
                          CyD-5
                        </span>
                      </div>
            ...
            <div className="absolute top-35 mt-3 pb-10 left-0 right-0 flex items-center h-20 py-[22px] w-full gap-2 bg-slate-200  dark:bg-slate-500 dark:text-white rounded-lg">
              <div className="flex items-center justify-between pb-2">
                <div className="flex items-center w-full ml-4">
                  <label className="custom-checkbox-container text-white cursor-pointer flex mt-2 font-normal text-sm">
                    <input
            ...
            <div className="absolute top-60 mt-2 left-0 right-0 flex items-center h-20 py-[22px] w-full gap-2 bg-slate-200 dark:bg-slate-500 dark:text-white rounded-lg">
              <div className="flex items-center justify-between pb-2">
                <div className="flex items-center w-full ml-4">
                  <label className="custom-checkbox-container text-white cursor-pointer flex mt-2 font-normal text-sm">
                    <input
            ...
            <div className="absolute top-80 mt-6 left-0 right-0 flex items-center h-20 py-[22px] w-full gap-2 bg-slate-200 dark:bg-slate-500 dark:text-white rounded-lg">
              <div className="flex items-center justify-between pb-2">
                <div className="flex items-center w-full ml-4">
                  <label className="custom-checkbox-container text-white cursor-pointer flex mt-2 font-normal text-sm">
                    <input
            ...
            <div className="absolute top-90 mt-20 left-0 right-0 flex items-center  h-20 py-[22px] w-full gap-2 bg-slate-200 dark:bg-slate-500 dark:text-white rounded-lg">
              <div className="flex items-center justify-between pb-2">
                <div className="flex items-center w-full ml-4">
                  <label className="custom-checkbox-container text-white cursor-pointer flex mt-2 font-normal text-sm">
                    <input
            ...
            <div className="absolute top-100 mt-34 left-0 right-0 flex items-center h-20 py-[22px] w-full gap-2 bg-slate-200 dark:bg-slate-500 dark:text-white rounded-lg">
              <div className="flex items-center justify-between pb-2">
                <div className="flex items-center w-full ml-4">
                  <label className="custom-checkbox-container text-white cursor-pointer flex mt-2 font-normal text-sm">
                    <input
            ...
            <div className="absolute top-100 right-0 mt-60 w-full flex items-center justify-between">
              {/* Left-aligned "8/page" */}
              <div className="h-3 w-5 ml-10 rounded-lg text-gray-400  text-[12px] text-center flex items-center justify-center cursor-pointer">
                <span>8/page</span>
              </div>

              {/* Right-aligned pagination controls */}
              <div className="flex gap-1 mr-8">
                <div className="h-3 w-5 rounded-md  text-[10px] flex items-center justify-center cursor-pointer">
                ...
                <div className="h-3 w-5 rounded-md  cursor-pointer text-[10px] flex items-center justify-center bg-gray-900">
                  1
                </div>
                <div className="h-3 w-5 rounded-md  text-[10px] flex items-center justify-center cursor-pointer">
                  2
                ...
                <div className="h-3 w-5 rounded-md  text-[22px] flex items-center justify-center cursor-pointer">
                  ...
                </div>
                <div className="h-3 w-5 rounded-md  text-[10px] flex items-center justify-center cursor-pointer">
                  10
